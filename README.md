...
reveals a copy button in its top-right corner. Code does not wrap — scroll
sideways, or hold Shift and scroll, to pan an overflowing fence; a fade at the
edge shows there is more. Drag to select text,
